<template>
  <div>
    <div class="card mb10">
      ...
      <span class="text">
        <el-link type="primary" href="https://docs.helloallen.cn" target="_blank">Allen-Admin</el-link>
    ...
    <div class="card mb10">
      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="Github" label-align="left">
          <el-link type="primary" href="https://github.com/HelloAllenW/Allen-Admin" target="_blank"> Github </el-link>
        </el-descriptions-item>
        <el-descriptions-item label="文档地址" label-align="left">
          <el-link type="primary" href="https://docs.helloallen.cn" target="_blank"> 文档地址 </el-link>
        </el-descriptions-item>
        <el-descriptions-item label="预览地址" label-align="left">
          <el-link type="primary" href="https://admin.helloallen.cn" target="_blank"> 预览地址 </el-link>
        </el-descriptions-item>
      </el-descriptions>
    </div>
    <div class="card mb10">
