<template>
  <vxe-toolbar>
    <template #buttons>
      <vxe-button style="margin-left: 20px" @click="toggleHeader()">开启/关闭右键菜单</vxe-button>
      <vxe-button @click="toggleHeader()">切换单元格样式</vxe-button>
      <vxe-button @click="toggleHeader()">单元格选中</vxe-button>
      <vxe-button @click="toggleHeader()">切换Header显示</vxe-button>
      <vxe-button @click="toggleHeader()">开启/关闭单选功能</vxe-button>
      <vxe-button @click="toggleHeader()">开启/关闭多选功能</vxe-button>
    </template>
  </vxe-toolbar>
  <div class="card vxe-table-box">
    <vxe-toolbar custom print ref="toolbarRef" :buttons="toolbarButtons" :refresh="{ query: findList }"> </vxe-toolbar>
    ...
    >
      ...
      <vxe-column type="expand" title="联系人" width="80">
...
<script setup lang="ts" name="extensionTable">
